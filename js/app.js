...
(function() {
    ...
    function updateTime() {
        ...
        for(i = 4; i >= 0; i--) {
        	p = Math.pow(2, i);
        	c = document.getElementById("hc" + p);

			c.setAttribute("fill", hour & p ? "red" : "");
        }

        for(i = 5; i >= 0; i--) {
        	p = Math.pow(2, i);
        	c = document.getElementById("mc" + p);

			c.setAttribute("fill", minute & p ? "red" : "");
        }

        for(i = 5; i >= 0; i--) {
        	p = Math.pow(2, i);
        	c = document.getElementById("sc" + p);

			c.setAttribute("fill", seconds & p ? "red" : "");
        }
    }
